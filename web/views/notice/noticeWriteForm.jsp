...
<form action="/first/ninsert.ad" method="post" enctype="multipart/form-data">
<!-- <form action="/first/ninsert.ad" method="post"> -->
...
<tr><th>파일 선택</th><td><input type="file" name="ofile"></td></tr>
