...
<button onclick="javascript:location.href='/first/views/notice/noticeWriteForm.jsp';">공지글 등록</button>
</div>
<%-- 공지사항 검색 --%>
<center>
<div>
...
<% for(Notice n : list){ %>
	<tr>
		...
		<td><a href="/first/ndetail.ad?noticeno=<%= n.getNoticeNo() %>"><%= n.getNoticeTitle() %></a></td>
