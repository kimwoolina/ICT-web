 ...
 * Generated at: 2020-12-16 02:18:25 UTC
...
public final class noticeAdminDetailView_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginMember == null){ //로그인 안 했다면 
      ...
      out.write(" 번 공지 상세보기 및 수정페이지 [관리자용]</h2>\r\n");
      out.write("<br>\r\n");
      out.write("<form action=\"/first/nupdate.ad\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
      out.write("\r\n");
 ...
 if(notice.getOriginalFilePath() != null){ //첨부파일 다운로드 기능 연결 
      ...
      out.write("<input type=\"button\" value=\"글삭제\" onclick=\"javascript:location.href='/first/ndelete.ad?no=");
      out.print( notice.getNoticeNo() );
      out.write("&rfile=");
      out.print( notice.getRenameFilePath() );
